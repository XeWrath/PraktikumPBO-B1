public class Tiket {
    ...
    public static void pesanJumlahTiket(int jumlahTiket) {
        ...
        assert jumlahTiket > 0 : "Jumlah tiket yang dipesan harus lebih dari 0";
        // Assertion untuk memastikan jumlah pemesanan tidak melebihi tiket yang
        // tersedia
        assert (jumlahTiket <= tiketTersedia) : "Jumlah tiket yang dipesan melebihi tiket yang tersedia";
    ...
    public static void isEWallet(int EWallet) {
        ...
        boolean isEWallet = EWallet >= 0 && EWallet <= 4;

        // Assertion untuk memastikan e-wallet yang dipilih valid
        assert isEWallet : "E-wallet yang dipilih tidak valid";
